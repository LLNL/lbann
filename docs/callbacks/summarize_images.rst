...
.. _TB: https://www.tensorflow.org/tensorboard
...
:ref:`Tensorboard<TB>`. The callback can be used to display
categorized images or images generated by an autoencoder.
...
+ Strategy
  ...
  strategy.
    ...
    - Track Sample IDs
      ...
      * Number of images to track. Default value is 10.
    ...
    - Categorical Accuracy
       ...
       * Name of the categorical accuracy layer. Defined in the
         Python front end.
       ...
       * Criteria for selecting images to output.

         .. note:: *In Python front end, enum values from
                   :python:`lbann.CategoricalAccuracyStrategy.MatchType`
                   must be used. The options are :c:`NOMATCH`,
                   :c:`MATCH`, or :c:`ALL`. Default value is
                   :c:`NOMATCH`.*
       ...
       * Number of images to output per epoch. Default value is 10.
