...
readers, or writting your own.  Currently, data readers serve two
...
Two of the new format data readers are the ``python``, ``SMILES``, and ``HDF5``
readers.

Several of these readers (SMILES and HDF5) support the use of **sample
lists**.  A sample list is a text file that is used to describe how
...
quickly change the data set used via a human readable and editable format.
...
Figures :numref:`hdf5_inclusive`_ and :numref:`hdf5_exclusive`_
