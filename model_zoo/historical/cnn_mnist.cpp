...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    // Target layer
    Layer *tlayer = new target_layer_distributed_minibatch<data_layout::MODEL_PARALLEL>(comm, dynamic_cast<generic_input_layer*>(ilayer), parallel_io, data_readers, true);
