...
def run_tests(actual_objective_functions, model_name, dir_name, cluster, should_log):
    ...
    error_if(outside_tolerance, '!=', 'training_objective_function', actual_objective_functions, expected_objective_functions, model_name, errors, all_values) 
...
def test_integration_model_conv_autoencoder_mnist(cluster, dirname, exes):
    ...
    run_tests(actual_objective_functions, model_name, dirname, cluster, should_log)
