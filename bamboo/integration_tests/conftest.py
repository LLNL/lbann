...
def pytest_addoption(parser):
    ...
    if cluster == 'ray':
        ...
        default_exes['gcc4_debug'] = '%s/bamboo/compiler_tests/builds/%s_gcc-4.9.3_ppc64le_gpu_cuda-9.2.64_cudnn-7.0_spectrum-mpi-2018.04.27_openblas_debug/build/model_zoo/lbann' % (default_dirname, cluster)
