...
[[ -z "${CENTER_COMPILER}" ]] && COMPILER_LABEL="-${CENTER_COMPILER}" || COMPILER_LABEL=""
...
LBANN_SETUP_FILE_LABEL="LBANN_${CLUSTER}_${LBANN_LABEL}-${SYS}${COMPILER_LABEL}_setup_build_tools.sh"
...
LBANN_INSTALL_FILE_LABEL="LBANN_${CLUSTER}_${LBANN_LABEL}-${SYS}${COMPILER_LABEL}_setup_module_path.sh"
