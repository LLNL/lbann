set_superbuild_externals()
{
    ...
    CMD="source ${prefix}/${system}/${dnn_lib}/${mpi}/logs/lbann_sb_suggested_cmake_prefix_path.sh"
...
cat <<EOF  >> ${yaml}
    adiak:
      ...
      - spec: adiak@master arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/adiak
    caliper:
      buildable: false
      version:
      - 'master'
      ...
      - spec: caliper@master arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/caliper
    catch2:
      buildable: false
      version:
      - '2.9.2'
      ...
      - spec: catch2@2.9.2 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/catch2
    hdf5:
      buildable: false
      version:
      - '1.10.9'
      ...
      - spec: hdf5@1.10.9 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/hdf5
    jpeg-turbo:
      buildable: false
      version:
      - '2.0.3'
      ...
      - spec: jpeg-turbo@2.0.3 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/jpeg-turbo
    spdlog:
      buildable: false
      version:
      - '1.12.0'
      ...
      - spec: spdlog@1.12.0 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/spdlog
    cereal:
      buildable: false
      version:
      - '1.3.0'
      ...
      - spec: cereal@1.3.0 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/cereal
    clara:
      buildable: false
      version:
      - '1.1.5'
      ...
      - spec: clara@1.1.5 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/clara
    cnpy:
      buildable: false
      version:
      - 'master'
      ...
      - spec: cnpy@master arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/cnpy
    conduit:
      buildable: false
      version:
      - 'develop'
      ...
      - spec: conduit@develop arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/conduit
    hiptt:
      buildable: false
      version:
      - 'master'
      ...
      - spec: hiptt@master arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/hiptt
    opencv:
      buildable: false
      version:
      - '4.1.0'
      ...
      - spec: opencv@4.1.0 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/opencv
    protobuf:
      buildable: false
      version:
      - '3.21.5'
...
cat <<EOF  >> ${yaml}
    nccl:
      ...
      - spec: nccl@2.19.4 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/nccl
    cudnn:
      buildable: false
      version:
      - '8.9.4'
...
cat <<EOF  >> ${yaml}
    openblas:
      ...
      - spec: openblas@0.3.6 arch=${spack_arch}
        prefix: ${prefix}/${system}/${dnn_lib}/${mpi}/openblas
EOF
}
