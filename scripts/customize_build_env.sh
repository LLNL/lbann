    ...
    if [[ ${center} = "llnl_lc" ]]; then
        ...
        case ${spack_arch_target} in
            ...
            "zen" | "zen2") # Corona
                ...
                ;;
            "zen3") # Tioga, RZVernal
                MODULE_CMD="module load craype-x86-trento craype-network-ofi libfabric/2.1 perftools-base/23.09.0 cce/16.0.1 craype/2.7.23 cray-mpich/8.1.28 cray-libsci/23.09.1.1 PrgEnv-cray StdEnv rocm/5.7.1 cmake/3.24.2"
                ;;
            *)
