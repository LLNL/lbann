...
#define LBANN_REGISTER_OPERATOR_WITH_CEREAL_BASE(NAME, TYPE) \
...
#define LBANN_REGISTER_OPERATOR_WITH_CEREAL(NAME, TYPE)            \
  LBANN_REGISTER_OPERATOR_WITH_CEREAL_BASE(                                \
    NAME, TYPE)

#define PROTO(T)                              \
  LBANN_REGISTER_OPERATOR_WITH_CEREAL(LBANN_OPERATOR_NAME, T)
