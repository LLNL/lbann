...
#ifndef LBANN_OPTIMIZERS_ADAM_IMPL_HPP_INCLUDED
#define LBANN_OPTIMIZERS_ADAM_IMPL_HPP_INCLUDED
...
void adam<TensorDataType>::serialize(Archive& ar)
{
  ar(cereal::base_class<data_type_optimizer<TensorDataType>>(this),
     ...
     CEREAL_NVP(m_beta2),
     CEREAL_NVP(m_eps),
     CEREAL_NVP(m_adamw_weight_decay),
...
#endif // LBANN_OPTIMIZERS_ADAM_IMPL_HPP_INCLUDED
