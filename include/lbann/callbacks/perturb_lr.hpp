...
#ifndef LBANN_CALLBACKS_CALLBACK_PERTURB_LR_HPP_INCLUDED
#define LBANN_CALLBACKS_CALLBACK_PERTURB_LR_HPP_INCLUDED
 ...
 */
class perturb_lr : public callback_base {
public:
   ...
   *                        perturbed.
   */
  perturb_lr(DataType learning_rate_factor,
               bool perturb_during_training = false,
               El::Int batch_interval = 1,
               std::set<std::string> weights_names
               = std::set<std::string>());
  perturb_lr* copy() const override { return new perturb_lr(*this); }
...
#endif // LBANN_CALLBACKS_CALLBACK_PERTURB_LR_HPP_INCLUDED
