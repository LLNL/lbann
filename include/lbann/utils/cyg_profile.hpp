...
void c_hash_set_thread_id(int id) __attribute__((no_instrument_function));
  ...
  static inline void __cyg_profile_func_enter (void *func, void *caller) __attribute__((no_instrument_function));
  static inline void __cyg_profile_func_exit (void *func, void *caller) __attribute__((no_instrument_function));
...
#define HASH_2(k,size,idxOut)      \
  ...
  static inline void __cyg_profile_func_exit (void *func, void *caller)
  {
  ...
  static inline void __cyg_profile_func_enter (void *func, void *caller)
  {
    if (c_hash_profiling_is_turned_on == 0) {
      return;
    }
