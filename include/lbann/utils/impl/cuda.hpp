...
//#define WRAP_BOOL_MATH_FUNCTION(func)                     \
//  __device__ __forceinline__                        \
//  bool func(const float& x) { return ::func(x); }    \
//  __device__ __forceinline__                        \
//  bool func(const double& x) { return ::func(x); }
//WRAP_BOOL_MATH_FUNCTION(isfinite)
//WRAP_BOOL_MATH_FUNCTION(isinf)
//WRAP_BOOL_MATH_FUNCTION(isnan)
template <typename T> __device__ __forceinline__
