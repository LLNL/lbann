...
std::cerr << "\nXX WARNING: in include/lbann/sample_list_hdf5.hpp, the destructor is about to call close_file_handle(h) for " << this->m_file_id_stats_map.size() << " values of h; this may throw an exception.\n\n";
