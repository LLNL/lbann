...
private:
   ...
   *
   *  Data samples are generated by randomly picking subsequences from
  ...
  /** @brief Sequence length for Skip-gram algorithm.
   *
   *  If this is less than the walk length, then contexts are
   *  generated by picking random subsequences from walks.
   */
