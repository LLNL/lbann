...
class target_layer_distributed_minibatch : public target_layer, public distributed_minibatch {
 ...
 public:
  ...
  void fp_compute() override {
    int num_samples_in_batch = fetch_to_local_matrix(Y_local_v, m_paired_input_layer->get_data_reader());
    if(is_current_root()) {
    ...
    distribute_from_local_matrix(Y_local, Ys, m_paired_input_layer->get_data_reader());
