...
private:
  ...
  template <typename U>
  friend void local_fp_compute_impl(mean_squared_error_layer<U, T_layout, Dev>& l);
  template <typename U>
  friend void local_bp_compute_impl(mean_squared_error_layer<U, T_layout, Dev>& l);
