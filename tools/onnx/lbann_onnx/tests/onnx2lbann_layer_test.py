...
from lbann_onnx.util import getLbannRoot, list2LbannList, lbannList2List

# TODO: Remove this once setup.py is added to pyproto
sys.path.append(os.path.join(getLbannRoot(), "scripts"))
import proto.lbann_proto as lp
