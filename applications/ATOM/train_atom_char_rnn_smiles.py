...
def construct_data_reader(run_args):
    ...
    data_reader.name = "smiles"
    data_reader.role = "train"
    data_reader.shuffle = True
    data_reader.sequence_length = sequence_length
    data_reader.percent_of_data_to_use = 1.0
    data_reader.data_filedir = "/usr/workspace/wsa/enamine"
    data_reader.data_filename = "all2018q1-2REAL680SMILES.smiles"
    data_reader.num_samples = 50000
