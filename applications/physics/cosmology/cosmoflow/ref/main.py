...
parser.add_argument(
    "--learning-rate", default=1e-3, type=float, help="Learning Rate (default: 1e-3)"
)
parser.add_argument("--batch-size", default=8, type=int, help="Batch Size (default: 8)")
parser.add_argument(
    "--num-epochs", default=50, type=int, help="Number of Training Epochs (default: 50)"
)
parser.add_argument(
    "--input-width",
    default=128,
...
parser.add_argument(
    "--preload", action="store_true", help="Preload Training/Validation Data"
)
parser.add_argument(
    "--use-batchnorm", action="store_true", help="Use batch normalization layers"
)
parser.add_argument(
