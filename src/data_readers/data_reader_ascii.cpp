...
bool ascii_reader::fetch_datum(CPUMat& X, int data_id, int mb_idx, thread_pool& io_thread_pool) {
...
bool ascii_reader::fetch_label(CPUMat& Y, int data_id, int mb_idx, thread_pool& io_thread_pool) {
