...
TEST_CASE("Testing random resized crop with fixed aspect ratio preprocessing",
          "[preproc]")
{
  ...
  SECTION("matrix with one channel")
  {
    ...
    {
      auto resize_cropper =
        lbann::transform::random_resized_crop_with_fixed_aspect_ratio(7,
                                                                      7,
                                                                      3,
                                                                      3);
    ...
    {
      auto resize_cropper =
        lbann::transform::random_resized_crop_with_fixed_aspect_ratio(3,
                                                                      3,
                                                                      1,
                                                                      1);
