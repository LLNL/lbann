...
perturb_lr::perturb_lr(DataType learning_rate_factor,
...
perturb_lr::perturb_lr()
  : perturb_lr(0, false, 0)
{}

template <class Archive>
void perturb_lr::serialize(Archive & ar) {
  ar(::cereal::make_nvp(
       "BaseCallback",
...
void perturb_lr::perturb(model& m) const {
...
void perturb_lr::perturb(lbann_comm& comm, data_type_optimizer<DataType>& opt) const {
...
build_perturb_lr_callback_from_pbuf(
  ...
  const auto& params =
    dynamic_cast<const lbann_data::Callback::CallbackPerturbLR&>(proto_msg);
  return make_unique<perturb_lr>(
...
#define LBANN_CLASS_NAME callback::perturb_lr
