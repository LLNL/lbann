...
void channelwise_softmax_layer<TensorDataType, Layout, Device>::serialize(
  ArchiveT& ar)
{
...
#define PROTO_DEVICE(T, D)                                                     \
  LBANN_ADD_ALL_SERIALIZE_ETI(                                                 \
    ::lbann::                                                                  \
      channelwise_softmax_layer<T, ::lbann::data_layout::DATA_PARALLEL, D>);   \
  CEREAL_REGISTER_TYPE_WITH_NAME(                                              \
    ::lbann::channelwise_softmax_layer<                                        \
