...
void lbann::input_layer_partitioned_minibatch_parallel_io::setup(int num_prev_neurons) {
 ...
 */
bool lbann::input_layer_partitioned_minibatch_parallel_io::update() {
...
void lbann::input_layer_partitioned_minibatch_parallel_io::preprocess_data_samples(Mat& M_local, int num_samples_in_batch) {
  return;
}
...
execution_mode lbann::input_layer_partitioned_minibatch_parallel_io::get_execution_mode() {
