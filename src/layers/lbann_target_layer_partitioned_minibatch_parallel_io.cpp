...
lbann::target_layer_partitioned_minibatch_parallel_io::target_layer_partitioned_minibatch_parallel_io(lbann_comm* comm, int num_parallel_readers, uint mini_batch_size, std::map<execution_mode, generic_data_reader*> data_readers, bool shared_data_reader, bool for_regression)
...
void lbann::target_layer_partitioned_minibatch_parallel_io::setup(int num_prev_neurons) {
...
void lbann::target_layer_partitioned_minibatch_parallel_io::fp_linearity() {
...
void lbann::target_layer_partitioned_minibatch_parallel_io::bp_linearity() {
 ...
 */
bool lbann::target_layer_partitioned_minibatch_parallel_io::update() {
