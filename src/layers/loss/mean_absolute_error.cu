...
template <typename TensorDataType>
void local_fp_compute_impl(mean_absolute_error_layer<TensorDataType, data_layout::MODEL_PARALLEL, El::Device::GPU>& l) {
...
template <typename TensorDataType>
void local_bp_compute_impl(mean_absolute_error_layer<TensorDataType, data_layout::MODEL_PARALLEL, El::Device::GPU>& l) {
...
template <typename TensorDataType>
void local_fp_compute_impl(mean_absolute_error_layer<TensorDataType, data_layout::DATA_PARALLEL, El::Device::GPU>& l) {
  local_fp_gpu<TensorDataType>(l.get_input_size(),
                               l.get_local_prev_activations(0),
                               l.get_local_prev_activations(1),
                               l.m_workspace->Matrix());
...
template <typename TensorDataType>
void local_bp_compute_impl(mean_absolute_error_layer<TensorDataType, data_layout::DATA_PARALLEL, El::Device::GPU>& l) {
  local_bp_gpu<TensorDataType>(l.get_input_size(),
                               l.get_local_prev_activations(0),
                               l.get_local_prev_activations(1),
                               l.m_workspace->LockedMatrix(),
