...
class TransformerEncoderLayerAllSubgraph(lbann.modules.Module):
	...
	def __init__(
		...
		# Layer modules
		self.attention = lbann.modules.transformer.MultiheadAttentionAllSubGraph(
			self.embed_dim,
			num_heads,
			branches=branches,
			d_kv = d_kv,
...
class TransformerEncoderLayerAllSubgraphInputSubGrids(lbann.modules.Module):
	...
	def __init__(
		...
		# Layer modules
		self.attention = lbann.modules.transformer.MultiheadAttentionAllSubGraphInputSubGrids(
			self.embed_dim,
			num_heads,
			branches=branches,
			d_kv = d_kv,
...
class TransformerDecoderLayerAllSubGraph(lbann.modules.Module):
	...
	def __init__(
		...
		# Layer modules
		self.attention1 = lbann.modules.transformer.MultiheadAttentionAllSubGraph(
			embed_dim,
			num_heads,
			branches=branches,
			d_kv = d_kv,
		...
		self.attention2 = lbann.modules.transformer.MultiheadAttentionAllSubGraphInputSubGrids(
			embed_dim,
			num_heads,
			branches=branches,
			d_kv = d_kv,
...
class TransformerDecoderLayerAllSubGraphInputSubGrids(lbann.modules.Module):
	...
	def __init__(
		...
		# Layer modules
		self.attention1 = lbann.modules.transformer.MultiheadAttentionAllSubGraphInputSubGrids(
			embed_dim,
			num_heads,
			branches=branches,
			d_kv = d_kv,
